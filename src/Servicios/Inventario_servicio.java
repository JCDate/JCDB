...
public class Inventario_servicio {
    ...
    public List<InventarioM> recuperarTodas(Connection conexion) throws SQLException {
        ...
        try {
            ...
            PreparedStatement consulta = conexion.prepareStatement("SELECT DISTINCT calibre,descripcion, num_calibre,unidad,milesimas ,existencia,kgs,tolerancia,peso_hoja,observaciones FROM " + this.tabla);
