...
public class TroqueladoresGUI extends javax.swing.JFrame {
    ...
    private void troqueles() {
        ...
        try {
            this.troqueladores = this.troqueladores_servicio.recuperarTodas(conexion);
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyReleased
        if (evt.getKeyCode() == com.sun.glass.events.KeyEvent.VK_ENTER) {
            try {
                ...
                consulta = conexion.prepareStatement("UPDATE troqueladores SET nombre='" + nombre + "',puesto='" + puesto + "' WHERE id_troquelador='" + id_troquelador + "'");
