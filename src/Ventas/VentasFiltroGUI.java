...
public class VentasFiltroGUI extends javax.swing.JFrame {
    ...
    private void Ventas(){
        try{
            ...
            consulta = conexion.prepareStatement("SELECT componente,cr, SUM(pzs) as Total FROM ventas WHERE SUBSTRING(fechaEmb, 7, 4)='"+anio+"' GROUP BY componente ORDER BY Total DESC, componente ASC");
