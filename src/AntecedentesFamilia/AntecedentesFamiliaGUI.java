...
public class AntecedentesFamiliaGUI extends javax.swing.JFrame {
    ...
    private void AntecedentesFamilia(){
        try{
            this.antFam = this.antFam_servicio.recuperarTodas(conexion);
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyReleased
        if(evt.getKeyCode() == com.sun.glass.events.KeyEvent.VK_ENTER){
            try {
                ...
                consulta = conexion.prepareStatement("UPDATE antecedentesfamilia SET familia='"+fam+"' WHERE componente='"+componente+"'");
