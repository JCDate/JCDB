...
public class menu extends javax.swing.JFrame {
    ...
    public void restaurarBackUp() {
        try {
            ...
            if (x == 0) {
                ...
                try (FileWriter fw = new FileWriter(fcopi)) {
    ...
    private void initComponents() {
        ...
        btnTroqueles.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnTroquelesActionPerformed(evt);
            }
        });
        ...
        btnUbicacionTroqueles.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnUbicacionTroquelesActionPerformed(evt);
            }
        });
        ...
        btnAntecedentesFamilia.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAntecedentesFamiliaActionPerformed(evt);
            }
        });
        ...
        btnPrecioComponente.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPrecioComponenteActionPerformed(evt);
            }
        });
        ...
        btnConsumoAntecedentes.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnConsumoAntecedentesActionPerformed(evt);
            }
        });
    ...
    private void btnConsumoAntecedentesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsumoAntecedentesActionPerformed
        try {
            //REPORTES
            btnRepProduccion.setVisible(false);
            btnIIPTroqueles.setVisible(false);
            ...
            ConsumoyAntecedentesGUI consumoAntecedentes = new ConsumoyAntecedentesGUI(mod);
            consumoAntecedentes.setVisible(true);
        } catch (SQLException | ClassNotFoundException ex) {
            Logger.getLogger(menu.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_btnConsumoAntecedentesActionPerformed
    ...
    private void btnAntecedentesFamiliaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAntecedentesFamiliaActionPerformed
        try {
            //REPORTES
            btnRepProduccion.setVisible(false);
            btnIIPTroqueles.setVisible(false);
            ...
            AntecedentesFamiliaGUI antecedentesFamilia = new AntecedentesFamiliaGUI(mod);
            antecedentesFamilia.setVisible(true);
        } catch (SQLException | ClassNotFoundException ex) {
            Logger.getLogger(menu.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_btnAntecedentesFamiliaActionPerformed

    private void btnPrecioComponenteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrecioComponenteActionPerformed
        try {
            //REPORTES
            btnRepProduccion.setVisible(false);
            btnIIPTroqueles.setVisible(false);
            ...
            PrecoComponenteGUI precioComponente = new PrecoComponenteGUI(mod);
            precioComponente.setVisible(true);
        } catch (SQLException | ClassNotFoundException ex) {
            Logger.getLogger(menu.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_btnPrecioComponenteActionPerformed

    private void btnUbicacionTroquelesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbicacionTroquelesActionPerformed
        try {
            //REPORTES
            btnRepProduccion.setVisible(false);
            btnIIPTroqueles.setVisible(false);
            ...
            UbicacionTroquel ubicacionTroquel = new UbicacionTroquel(mod);
            ubicacionTroquel.setVisible(true);
        } catch (SQLException | ClassNotFoundException ex) {
            Logger.getLogger(menu.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_btnUbicacionTroquelesActionPerformed

    private void btnTroquelesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTroquelesActionPerformed
        try {
            //REPORTES
            btnRepProduccion.setVisible(false);
            btnIIPTroqueles.setVisible(false);
            ...
            troqueles Troqueles = new troqueles(mod);
            Troqueles.setVisible(true);
        } catch (SQLException | ClassNotFoundException ex) {
            Logger.getLogger(menu.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_btnTroquelesActionPerformed
