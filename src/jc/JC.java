...
public class JC extends javax.swing.JFrame {
    ...
    public JC() {
        ...
        //Iniciar Sesión al oprimir Enter
        ...
        cbxRecuerdame.setSelected(usr != null && !usr.isEmpty());
    ...
    private void initComponents() {
        ...
        cbxRecuerdame.setText("Recordarme");
        cbxRecuerdame.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cbxRecuerdameMouseClicked(evt);
            }
        });
        jPanel1.add(cbxRecuerdame, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 200, -1, -1));
        ...
        jPanel1.add(btnIniciarSesion, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 240, -1, -1));
        ...
        jPanel1.add(lblContrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 160, -1, -1));

        lblIconoContrasena.setIcon(new javax.swing.ImageIcon(getClass().getResource("/jc/img/bloquear.png"))); // NOI18N
        jPanel1.add(lblIconoContrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 150, -1, -1));
        ...
        jPanel1.add(txtContraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 150, 270, 40));
    ...
    private void cbxRecuerdameMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cbxRecuerdameMouseClicked
        if (cbxRecuerdame.isSelected()) {
            recordar(true);
        } else {
            recordar(false);
        }
    }//GEN-LAST:event_cbxRecuerdameMouseClicked

    public void recordar(boolean recordar) {
        if (recordar) {
            String pass = new String(txtContraseña.getPassword()); // Se obtiene la contraseña ingresada por el Usuario
            guardarPreferencias(txtUsuario.getText(), pass);
        } else {
