...
public class ModificarPrecioMP extends javax.swing.JFrame {
    ...
    public ModificarPrecioMP(PrecioMP p_precio, Usuarios mod) {
        ...
        this.precio2.setCalibre(txtCalibre.getText());
        this.precio2.setPesoUnitario(Float.parseFloat(txtPU.getText()));
        this.precio2.setMoneda(txtMoneda.getText());
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnGuardarPrecio, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 190, 140, -1));
    ...
    private void btnGuardarPrecioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarPrecioActionPerformed
        ...
        if (!calibre.trim().equals("")) {
            ...
            try {
                this.precioMP_servicio.modificar(Conexion.getInstance().getConnection(), this.precio, this.precio2);
