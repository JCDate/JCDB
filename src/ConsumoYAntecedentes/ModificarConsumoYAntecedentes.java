 ...
 @Override
    ...
    private void guardar(){
        ...
        if(!componente_CA.trim().equals("")){
            ...
            try{
                this.cas.modificar(Conexion.getInstance().getConnection(), this.cya);
                
                //Actualizar peso estampa= peso unitario
                PreparedStatement pst = conexion.prepareStatement("UPDATE estructura SET estructura.peso_estamp =(SELECT consumoyantecedentes.consumo_uni FROM consumoyantecedentes WHERE estructura.componente= consumoyantecedentes.componente_CA )");
                pst.executeUpdate();
