...
public class ModificarCRs extends javax.swing.JFrame {
 ...
 @Override
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 200, 140, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            try{
                this.crs_servicio. modificar(Conexion.getInstance().getConnection(), this.crs);
                //Actualizar cr de estructura 
                PreparedStatement pst = conexion.prepareStatement("UPDATE estructura SET estructura.CR =(SELECT crs.cr FROM crs WHERE estructura.componente= crs.componente)");
                pst.executeUpdate();
