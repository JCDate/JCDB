...
public class ModificarRepDiarioPrdo extends javax.swing.JFrame {
    ...
    public void maquinas() {
        try {
            this.tiempoMaquinas = this.tiempoMaquinas_servicio.recuperarTodas(conexion);
            choice1.add("------");
    ...
    private void guardar() {
        ...
        try {
            this.rep_servicio.modificar(conexion, this.rep);
            ModificarRepDiarioPrdo.this.dispose();
            ...
            PreparedStatement pst = conexion.prepareStatement("UPDATE repdiarot JOIN repdiprod ON repdiprod.id = repdiarot.id SET repdiarot.cantParcial = repdiprod.cantParcial,  repdiarot.cantProd = repdiprod.cantProd");
            pst.executeUpdate();

            PreparedStatement pst2 = conexion.prepareStatement("DELETE FROM repdiarot WHERE cantParcial < contS");
            pst2.executeUpdate();
