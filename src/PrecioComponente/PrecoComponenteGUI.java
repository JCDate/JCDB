...
public class PrecoComponenteGUI extends javax.swing.JFrame {
    ...
    private void PrecioComponente() {
        try {
            ...
            this.precioComponente = this.precioComponente_servicio.recuperarTodas(conexion);
            ...
            for (int i = 0; i < this.precioComponente.size(); i++) {
                dtm.addRow(new Object[]{
                    ...
                    this.precioComponente.get(i).getFechaActualizacion()
                });
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "COMPONENTE", "PRECIO UNITARIO", "ÚLTIMA ACTUALIZACIÓN"
            }
        ));
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyReleased
        if (evt.getKeyCode() == com.sun.glass.events.KeyEvent.VK_ENTER) {
            try {
                ...
                consulta = conexion.prepareStatement("UPDATE preciocomponente SET precioU='" + precioU + "' WHERE componente='" + componente + "'");
