...
public class SIM_CURRENTGUILimpio extends javax.swing.JFrame {
    ...
    private void SIM_CURRENTGUI() {
        try {
            this.simcurrent = this.simcurrent_servicio.recuperarTodas(conexion);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if (resultado > 0) {
                ...
                PreparedStatement pst3 = conexion.prepareStatement("UPDATE analisisatrasos, nuevasordenes SET piezasEntregar= cantidad_reque WHERE analisisatrasos.orden=nuevasordenes.orden");
                pst3.executeUpdate();

                //Eliminar datos repetidos de la tabla comparacionordenes
                PreparedStatement pst5 = conexion.prepareStatement("Delete N1 FROM comparacionordenes N1, comparacionordenes N2 WHERE N1.componente = N2.componente And N1.orden = N2.orden And N1.id>N2.id");
                pst5.executeUpdate();

                //LOTE ECONOMICO SI O NO
                PreparedStatement pst6 = conexion.prepareStatement("UPDATE nuevasordenes, loteeconomico SET loteeconomico='SI' WHERE nuevasordenes.componente= loteeconomico.componente AND loteeconomico.cantAct != 0");
                pst6.executeUpdate();
            ...
            PreparedStatement pst6 = conexion.prepareStatement("DELETE FROM sim_current WHERE 1");
            pst6.executeUpdate();
