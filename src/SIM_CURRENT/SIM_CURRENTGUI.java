    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            for(int i=0; i< jTable1.getRowCount(); i++){
               PreparedStatement pst = conexion.prepareStatement("INSERT INTO sim_current (fechaRecibida, consignatario, item_cliente, orden, fechaVencida, cantidad_reque) VALUES(?,?,?,?,?,?)");           
            ...
            //Borrar datos vacios 
            PreparedStatement pst2 = conexion.prepareStatement("DELETE FROM sim_current WHERE orden='' OR cantidad_reque<100");    
            pst2.executeUpdate();
