...
public class CotizacionAgregar extends javax.swing.JFrame {
    ...
    public void agregarCot(){
        try {
            ...
            PreparedStatement consulta = conexion.prepareStatement("SELECT troquel FROM troqueles WHERE componente ='"+componente+"'");
 ...
 @Override
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 200, 140, 40));
        ...
        getContentPane().add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 310, -1, 40));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
            ...
            try{
                ...
                {
                    this.co_servicio. agregar(conexion, this.co);
                    //Actualizar cr de cotizacion
                    PreparedStatement pst = conexion.prepareStatement("UPDATE cotizaciontmpd SET cotizaciontmpd.cr =(SELECT crs.cr FROM crs WHERE cotizaciontmpd.componente= crs.componente)");
                    pst.executeUpdate();

                    this.sol_servicio. agregar(conexion, this.sol);
                    
                    PreparedStatement pst2 = conexion.prepareStatement("UPDATE solicitudtmpd SET fechaSol='',envioCot='',enviadoSKF='',aprobadoSKF='',solicitudM='',fechaMaq='',temple='',ajuste='',produccion='',pzFacturadaSKF='' WHERE  fechaSol IS NULL");
                    pst2.executeUpdate();
