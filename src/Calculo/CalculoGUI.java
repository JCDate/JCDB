...
public class CalculoGUI extends javax.swing.JFrame {
    ...
    private void CalculoGUI(){
        try{
            ...
            this.DLP = this.DLP_servicio.recuperarTodas(Conexion.getInstance().getConnection());
            ...
            this.DT = this.DT_servicio.recuperarTodas(Conexion.getInstance().getConnection());
            ...
            this.CT = this.CT_servicio.recuperarTodas(Conexion.getInstance().getConnection());
