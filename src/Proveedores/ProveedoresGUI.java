...
public class ProveedoresGUI extends javax.swing.JFrame {
    ...
    private void ProveedoresGUI() {
        try {
            this.prov = this.proveedores_servicio.recuperarTodas(Conexion.getInstance().getConnection());
    ...
    private void initComponents() {
        ...
        jLabel2.setMaximumSize(new java.awt.Dimension(1370, 37));
        jLabel2.setMinimumSize(new java.awt.Dimension(1370, 37));
        jLabel2.setPreferredSize(new java.awt.Dimension(1370, 37));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 500, 120, 50));
