...
public class OrdenCompraGUI extends javax.swing.JFrame {
    ...
    public OrdenCompraGUI() {
        ...
        btnExportaeExcel.setFocusPainted(false);
        btnExportaeExcel.setBorderPainted(false);
    ...
    private void OrdenCompraGUI() {
        try {
            this.ordenCom = this.ordenCompra_servicio.recuperarTodas(Conexion.getInstance().getConnection());
    ...
    private void initComponents() {
        ...
        btnExportaeExcel = new javax.swing.JButton();
        ...
        getContentPane().add(btnModificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, 140, 40));
        ...
        btnExportaeExcel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/jc/img/excel.png"))); // NOI18N
        btnExportaeExcel.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnExportaeExcelActionPerformed(evt);
            }
        });
        getContentPane().add(btnExportaeExcel, new org.netbeans.lib.awtextra.AbsoluteConstraints(1210, 0, 60, 60));
    ...
    private void btnExportaeExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportaeExcelActionPerformed
        excel.WriteExcelOrdenCompra();
        JOptionPane.showMessageDialog(this, "Datos Exportados.");
    }//GEN-LAST:event_btnExportaeExcelActionPerformed
    ...
    private javax.swing.JButton btnExportaeExcel;
