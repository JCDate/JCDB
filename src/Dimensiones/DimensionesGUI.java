...
public class DimensionesGUI extends javax.swing.JFrame {
    ...
    private void DimGUI(){
        try{
            ...
            this.dim = this.dim_servicio.recuperarTodas(Conexion.getInstance().getConnection());
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyReleased
       if(evt.getKeyCode() == com.sun.glass.events.KeyEvent.VK_ENTER){
            try {
                ...
                consulta = conexion.prepareStatement("UPDATE dim SET diaEx='"+diaEx+"',diaInt='"+diaInt+"', altura='"+altura+"' WHERE componente='"+componente+"'");
