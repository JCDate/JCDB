    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            for(int i=0; i< jTable1.getRowCount(); i++)
            {
                    ...
                    PreparedStatement pst = conexion.prepareStatement("INSERT INTO pronostico(supplier, componente, mes1, mes2, mes3, mes4) VALUES(?,?,?,?,?,?)");
            ...
            for(int i=0; i< jTable1.getRowCount(); i++)
            {
            PreparedStatement pst2 = conexion.prepareStatement("DELETE FROM pronostico WHERE mes1='' and mes2='' and mes3='' and mes4=''");
            pst2.executeUpdate();
            }
            
            // eliminar los ceros de mas
            PreparedStatement pst = conexion.prepareStatement("UPDATE pronostico SET componente =(if(componente LIKE '1%' OR componente LIKE '2%' AND CHAR_LENGTH(componente)>6 , SUBSTRING(componente, 1, CHAR_LENGTH(componente) - 2), componente) )");
            pst.executeUpdate();
            
            //Calibre
            PreparedStatement pst3 = conexion.prepareStatement("UPDATE pronostico JOIN estructura ON estructura.componente = pronostico.componente SET pronostico.calibre = estructura.calibre");
            pst3.executeUpdate();
            
            //Consumo Unitario
            PreparedStatement pst4 = conexion.prepareStatement("UPDATE pronostico JOIN estructura ON estructura.componente = pronostico.componente SET pronostico.consumoU = estructura.peso_estamp");
            pst4.executeUpdate();
            
            
            //Precio Unitacio
            PreparedStatement pst5 = conexion.prepareStatement("UPDATE pronostico JOIN preciomp ON preciomp.calibre = pronostico.calibre SET pronostico.pesoUnitario = preciomp.pesoUnitario");
            pst5.executeUpdate();
            
            //Precio Unitacio
            PreparedStatement pst6 = conexion.prepareStatement("UPDATE pronostico JOIN preciomp ON preciomp.calibre = pronostico.calibre SET pronostico.moneda = preciomp.moneda");
            pst6.executeUpdate();
